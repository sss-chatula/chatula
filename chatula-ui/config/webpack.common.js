  ...
  return {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([
        ...
        { from: 'src/meta'},
          {from: 'src/chatula-service.js'},
          {from: 'src/chatula-binding.js'},
          {from: 'src/chatula-tool.js'},
          {from: 'src/chatula-ui.js'},
          {from: 'src/chatula.html'},
          {from: 'src/chatula.css'},
          {from: 'src/snippet.js'},
          {from: 'src/message.mp3'}
        ],
